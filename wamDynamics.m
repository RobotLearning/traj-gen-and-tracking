...
%
% TODO: put it in the usual forward dynamics representation
%       add friction terms?
%
% If flag is set to true, return the jacobians of the dynamics f

function [Qd,varargout]  =  wamDynamics(Q,u,PAR,flag)

NDOF  =  7;
% system states are X  =  (q(1),...q(7),qd(1),...,qd(7));
q  =  Q(1:NDOF);
qd  =  Q(NDOF+1:2*NDOF);
u0 = u; % used in linearization
...
% pv-misc vectors 
pv0(1) = -(link0.mcm(1)*power(v0(2),2)) - link0.mcm(1)*power(v0(3),2) + v0(1)*(link0.mcm(2)*v0(2) + link0.mcm(3)*v0(3)) - link0.m*v0(3)*v0(5) + link0.m*v0(2)*v0(6) - uex0.f(1)*S00(1,1) - uex0.f(2)*S00(1,2) + g*link0.m*S00(1,3) - uex0.f(3)*S00(1,3);
pv0(2) = -(link0.mcm(2)*power(v0(1),2)) - link0.mcm(2)*power(v0(3),2) + v0(2)*(link0.mcm(1)*v0(1) + link0.mcm(3)*v0(3)) + link0.m*v0(3)*v0(4) - link0.m*v0(1)*v0(6) - uex0.f(1)*S00(2,1) - uex0.f(2)*S00(2,2) + g*link0.m*S00(2,3) - uex0.f(3)*S00(2,3);
pv0(3) = -(link0.mcm(3)*power(v0(1),2)) - link0.mcm(3)*power(v0(2),2) + (link0.mcm(1)*v0(1) + link0.mcm(2)*v0(2))*v0(3) - link0.m*v0(2)*v0(4) + link0.m*v0(1)*v0(5) - uex0.f(1)*S00(3,1) - uex0.f(2)*S00(3,2) + g*link0.m*S00(3,3) - uex0.f(3)*S00(3,3);
pv0(4) = (-(link0.mcm(2)*v0(2)) - link0.mcm(3)*v0(3))*v0(4) + (link0.mcm(1)*v0(3) + link0.m*v0(5))*v0(6) + v0(5)*(link0.mcm(1)*v0(2) - link0.m*v0(6)) + v0(1)*(link0.mcm(2)*v0(5) + link0.mcm(3)*v0(6) - v0(3)*link0.inertia(1,2) + v0(2)*link0.inertia(1,3)) + v0(2)*(-(link0.mcm(1)*v0(5)) - v0(3)*link0.inertia(2,2) + v0(2)*link0.inertia(2,3)) + v0(3)*(-(link0.mcm(1)*v0(6)) - v0(3)*link0.inertia(2,3) + v0(2)*link0.inertia(3,3)) - uex0.t(1)*S00(1,1) - uex0.t(2)*S00(1,2) - uex0.t(3)*S00(1,3) - g*link0.mcm(3)*S00(2,3) + g*link0.mcm(2)*S00(3,3);
pv0(5) = (-(link0.mcm(1)*v0(1)) - link0.mcm(3)*v0(3))*v0(5) + (link0.mcm(2)*v0(3) - link0.m*v0(4))*v0(6) + v0(4)*(link0.mcm(2)*v0(1) + link0.m*v0(6)) + v0(1)*(-(link0.mcm(2)*v0(4)) + v0(3)*link0.inertia(1,1) - v0(1)*link0.inertia(1,3)) + v0(2)*(link0.mcm(1)*v0(4) + link0.mcm(3)*v0(6) + v0(3)*link0.inertia(1,2) - v0(1)*link0.inertia(2,3)) + v0(3)*(-(link0.mcm(2)*v0(6)) + v0(3)*link0.inertia(1,3) - v0(1)*link0.inertia(3,3)) + g*link0.mcm(3)*S00(1,3) - uex0.t(1)*S00(2,1) - uex0.t(2)*S00(2,2) - uex0.t(3)*S00(2,3) - g*link0.mcm(1)*S00(3,3);
pv0(6) = (link0.mcm(3)*v0(2) + link0.m*v0(4))*v0(5) + v0(4)*(link0.mcm(3)*v0(1) - link0.m*v0(5)) + (-(link0.mcm(1)*v0(1)) - link0.mcm(2)*v0(2))*v0(6) + v0(1)*(-(link0.mcm(3)*v0(4)) - v0(2)*link0.inertia(1,1) + v0(1)*link0.inertia(1,2)) + v0(2)*(-(link0.mcm(3)*v0(5)) - v0(2)*link0.inertia(1,2) + v0(1)*link0.inertia(2,2)) + v0(3)*(link0.mcm(1)*v0(4) + link0.mcm(2)*v0(5) - v0(2)*link0.inertia(1,3) + v0(1)*link0.inertia(2,3)) - g*link0.mcm(2)*S00(1,3) + g*link0.mcm(1)*S00(2,3) - uex0.t(1)*S00(3,1) - uex0.t(2)*S00(3,2) - uex0.t(3)*S00(3,3);

pv1(1) = -(links(1).mcm(1)*power(v1(2),2)) - links(1).mcm(1)*power(v1(3),2) + v1(1)*(links(1).mcm(2)*v1(2) + links(1).mcm(3)*v1(3)) - links(1).m*v1(3)*v1(5) + links(1).m*v1(2)*v1(6) - uex(1).f(1)*SG10(1,1) - uex(1).f(2)*SG10(1,2) + g*links(1).m*SG10(1,3) - uex(1).f(3)*SG10(1,3);
pv1(2) = -(links(1).mcm(2)*power(v1(1),2)) - links(1).mcm(2)*power(v1(3),2) + v1(2)*(links(1).mcm(1)*v1(1) + links(1).mcm(3)*v1(3)) + links(1).m*v1(3)*v1(4) - links(1).m*v1(1)*v1(6) - uex(1).f(1)*SG10(2,1) - uex(1).f(2)*SG10(2,2) + g*links(1).m*SG10(2,3) - uex(1).f(3)*SG10(2,3);
pv1(3) = -(links(1).mcm(3)*power(v1(1),2)) - links(1).mcm(3)*power(v1(2),2) + (links(1).mcm(1)*v1(1) + links(1).mcm(2)*v1(2))*v1(3) - links(1).m*v1(2)*v1(4) + links(1).m*v1(1)*v1(5) - uex(1).f(1)*SG10(3,1) - uex(1).f(2)*SG10(3,2) + g*links(1).m*SG10(3,3) - uex(1).f(3)*SG10(3,3);
pv1(4) = (-(links(1).mcm(2)*v1(2)) - links(1).mcm(3)*v1(3))*v1(4) + (links(1).mcm(1)*v1(3) + links(1).m*v1(5))*v1(6) + v1(5)*(links(1).mcm(1)*v1(2) - links(1).m*v1(6)) + v1(1)*(links(1).mcm(2)*v1(5) + links(1).mcm(3)*v1(6) - v1(3)*links(1).inertia(1,2) + v1(2)*links(1).inertia(1,3)) + v1(2)*(-(links(1).mcm(1)*v1(5)) - v1(3)*links(1).inertia(2,2) + v1(2)*links(1).inertia(2,3)) + v1(3)*(-(links(1).mcm(1)*v1(6)) - v1(3)*links(1).inertia(2,3) + v1(2)*links(1).inertia(3,3)) - uex(1).t(1)*SG10(1,1) - uex(1).t(2)*SG10(1,2) - uex(1).t(3)*SG10(1,3) - g*links(1).mcm(3)*SG10(2,3) + g*links(1).mcm(2)*SG10(3,3);
pv1(5) = (-(links(1).mcm(1)*v1(1)) - links(1).mcm(3)*v1(3))*v1(5) + (links(1).mcm(2)*v1(3) - links(1).m*v1(4))*v1(6) + v1(4)*(links(1).mcm(2)*v1(1) + links(1).m*v1(6)) + v1(1)*(-(links(1).mcm(2)*v1(4)) + v1(3)*links(1).inertia(1,1) - v1(1)*links(1).inertia(1,3)) + v1(2)*(links(1).mcm(1)*v1(4) + links(1).mcm(3)*v1(6) + v1(3)*links(1).inertia(1,2) - v1(1)*links(1).inertia(2,3)) + v1(3)*(-(links(1).mcm(2)*v1(6)) + v1(3)*links(1).inertia(1,3) - v1(1)*links(1).inertia(3,3)) + g*links(1).mcm(3)*SG10(1,3) - uex(1).t(1)*SG10(2,1) - uex(1).t(2)*SG10(2,2) - uex(1).t(3)*SG10(2,3) - g*links(1).mcm(1)*SG10(3,3);
pv1(6) = (links(1).mcm(3)*v1(2) + links(1).m*v1(4))*v1(5) + v1(4)*(links(1).mcm(3)*v1(1) - links(1).m*v1(5)) + (-(links(1).mcm(1)*v1(1)) - links(1).mcm(2)*v1(2))*v1(6) + v1(1)*(-(links(1).mcm(3)*v1(4)) - v1(2)*links(1).inertia(1,1) + v1(1)*links(1).inertia(1,2)) + v1(2)*(-(links(1).mcm(3)*v1(5)) - v1(2)*links(1).inertia(1,2) + v1(1)*links(1).inertia(2,2)) + v1(3)*(links(1).mcm(1)*v1(4) + links(1).mcm(2)*v1(5) - v1(2)*links(1).inertia(1,3) + v1(1)*links(1).inertia(2,3)) - g*links(1).mcm(2)*SG10(1,3) + g*links(1).mcm(1)*SG10(2,3) - uex(1).t(1)*SG10(3,1) - uex(1).t(2)*SG10(3,2) - uex(1).t(3)*SG10(3,3);

pv2(1) = -(links(2).mcm(1)*power(v2(2),2)) - links(2).mcm(1)*power(v2(3),2) + v2(1)*(links(2).mcm(2)*v2(2) + links(2).mcm(3)*v2(3)) - links(2).m*v2(3)*v2(5) + links(2).m*v2(2)*v2(6) - uex(2).f(1)*SG20(1,1) - uex(2).f(2)*SG20(1,2) + g*links(2).m*SG20(1,3) - uex(2).f(3)*SG20(1,3);
pv2(2) = -(links(2).mcm(2)*power(v2(1),2)) - links(2).mcm(2)*power(v2(3),2) + v2(2)*(links(2).mcm(1)*v2(1) + links(2).mcm(3)*v2(3)) + links(2).m*v2(3)*v2(4) - links(2).m*v2(1)*v2(6) - uex(2).f(1)*SG20(2,1) - uex(2).f(2)*SG20(2,2) + g*links(2).m*SG20(2,3) - uex(2).f(3)*SG20(2,3);
pv2(3) = -(links(2).mcm(3)*power(v2(1),2)) - links(2).mcm(3)*power(v2(2),2) + (links(2).mcm(1)*v2(1) + links(2).mcm(2)*v2(2))*v2(3) - links(2).m*v2(2)*v2(4) + links(2).m*v2(1)*v2(5) - uex(2).f(1)*SG20(3,1) - uex(2).f(2)*SG20(3,2) + g*links(2).m*SG20(3,3) - uex(2).f(3)*SG20(3,3);
pv2(4) = (-(links(2).mcm(2)*v2(2)) - links(2).mcm(3)*v2(3))*v2(4) + (links(2).mcm(1)*v2(3) + links(2).m*v2(5))*v2(6) + v2(5)*(links(2).mcm(1)*v2(2) - links(2).m*v2(6)) + v2(1)*(links(2).mcm(2)*v2(5) + links(2).mcm(3)*v2(6) - v2(3)*links(2).inertia(1,2) + v2(2)*links(2).inertia(1,3)) + v2(2)*(-(links(2).mcm(1)*v2(5)) - v2(3)*links(2).inertia(2,2) + v2(2)*links(2).inertia(2,3)) + v2(3)*(-(links(2).mcm(1)*v2(6)) - v2(3)*links(2).inertia(2,3) + v2(2)*links(2).inertia(3,3)) - uex(2).t(1)*SG20(1,1) - uex(2).t(2)*SG20(1,2) - uex(2).t(3)*SG20(1,3) - g*links(2).mcm(3)*SG20(2,3) + g*links(2).mcm(2)*SG20(3,3);
pv2(5) = (-(links(2).mcm(1)*v2(1)) - links(2).mcm(3)*v2(3))*v2(5) + (links(2).mcm(2)*v2(3) - links(2).m*v2(4))*v2(6) + v2(4)*(links(2).mcm(2)*v2(1) + links(2).m*v2(6)) + v2(1)*(-(links(2).mcm(2)*v2(4)) + v2(3)*links(2).inertia(1,1) - v2(1)*links(2).inertia(1,3)) + v2(2)*(links(2).mcm(1)*v2(4) + links(2).mcm(3)*v2(6) + v2(3)*links(2).inertia(1,2) - v2(1)*links(2).inertia(2,3)) + v2(3)*(-(links(2).mcm(2)*v2(6)) + v2(3)*links(2).inertia(1,3) - v2(1)*links(2).inertia(3,3)) + g*links(2).mcm(3)*SG20(1,3) - uex(2).t(1)*SG20(2,1) - uex(2).t(2)*SG20(2,2) - uex(2).t(3)*SG20(2,3) - g*links(2).mcm(1)*SG20(3,3);
pv2(6) = (links(2).mcm(3)*v2(2) + links(2).m*v2(4))*v2(5) + v2(4)*(links(2).mcm(3)*v2(1) - links(2).m*v2(5)) + (-(links(2).mcm(1)*v2(1)) - links(2).mcm(2)*v2(2))*v2(6) + v2(1)*(-(links(2).mcm(3)*v2(4)) - v2(2)*links(2).inertia(1,1) + v2(1)*links(2).inertia(1,2)) + v2(2)*(-(links(2).mcm(3)*v2(5)) - v2(2)*links(2).inertia(1,2) + v2(1)*links(2).inertia(2,2)) + v2(3)*(links(2).mcm(1)*v2(4) + links(2).mcm(2)*v2(5) - v2(2)*links(2).inertia(1,3) + v2(1)*links(2).inertia(2,3)) - g*links(2).mcm(2)*SG20(1,3) + g*links(2).mcm(1)*SG20(2,3) - uex(2).t(1)*SG20(3,1) - uex(2).t(2)*SG20(3,2) - uex(2).t(3)*SG20(3,3);

pv3(1) = -(links(3).mcm(1)*power(v3(2),2)) - links(3).mcm(1)*power(v3(3),2) + v3(1)*(links(3).mcm(2)*v3(2) + links(3).mcm(3)*v3(3)) - links(3).m*v3(3)*v3(5) + links(3).m*v3(2)*v3(6) - uex(3).f(1)*SG30(1,1) - uex(3).f(2)*SG30(1,2) + g*links(3).m*SG30(1,3) - uex(3).f(3)*SG30(1,3);
pv3(2) = -(links(3).mcm(2)*power(v3(1),2)) - links(3).mcm(2)*power(v3(3),2) + v3(2)*(links(3).mcm(1)*v3(1) + links(3).mcm(3)*v3(3)) + links(3).m*v3(3)*v3(4) - links(3).m*v3(1)*v3(6) - uex(3).f(1)*SG30(2,1) - uex(3).f(2)*SG30(2,2) + g*links(3).m*SG30(2,3) - uex(3).f(3)*SG30(2,3);
pv3(3) = -(links(3).mcm(3)*power(v3(1),2)) - links(3).mcm(3)*power(v3(2),2) + (links(3).mcm(1)*v3(1) + links(3).mcm(2)*v3(2))*v3(3) - links(3).m*v3(2)*v3(4) + links(3).m*v3(1)*v3(5) - uex(3).f(1)*SG30(3,1) - uex(3).f(2)*SG30(3,2) + g*links(3).m*SG30(3,3) - uex(3).f(3)*SG30(3,3);
pv3(4) = (-(links(3).mcm(2)*v3(2)) - links(3).mcm(3)*v3(3))*v3(4) + (links(3).mcm(1)*v3(3) + links(3).m*v3(5))*v3(6) + v3(5)*(links(3).mcm(1)*v3(2) - links(3).m*v3(6)) + v3(1)*(links(3).mcm(2)*v3(5) + links(3).mcm(3)*v3(6) - v3(3)*links(3).inertia(1,2) + v3(2)*links(3).inertia(1,3)) + v3(2)*(-(links(3).mcm(1)*v3(5)) - v3(3)*links(3).inertia(2,2) + v3(2)*links(3).inertia(2,3)) + v3(3)*(-(links(3).mcm(1)*v3(6)) - v3(3)*links(3).inertia(2,3) + v3(2)*links(3).inertia(3,3)) - uex(3).t(1)*SG30(1,1) - uex(3).t(2)*SG30(1,2) - uex(3).t(3)*SG30(1,3) - g*links(3).mcm(3)*SG30(2,3) + g*links(3).mcm(2)*SG30(3,3);
pv3(5) = (-(links(3).mcm(1)*v3(1)) - links(3).mcm(3)*v3(3))*v3(5) + (links(3).mcm(2)*v3(3) - links(3).m*v3(4))*v3(6) + v3(4)*(links(3).mcm(2)*v3(1) + links(3).m*v3(6)) + v3(1)*(-(links(3).mcm(2)*v3(4)) + v3(3)*links(3).inertia(1,1) - v3(1)*links(3).inertia(1,3)) + v3(2)*(links(3).mcm(1)*v3(4) + links(3).mcm(3)*v3(6) + v3(3)*links(3).inertia(1,2) - v3(1)*links(3).inertia(2,3)) + v3(3)*(-(links(3).mcm(2)*v3(6)) + v3(3)*links(3).inertia(1,3) - v3(1)*links(3).inertia(3,3)) + g*links(3).mcm(3)*SG30(1,3) - uex(3).t(1)*SG30(2,1) - uex(3).t(2)*SG30(2,2) - uex(3).t(3)*SG30(2,3) - g*links(3).mcm(1)*SG30(3,3);
pv3(6) = (links(3).mcm(3)*v3(2) + links(3).m*v3(4))*v3(5) + v3(4)*(links(3).mcm(3)*v3(1) - links(3).m*v3(5)) + (-(links(3).mcm(1)*v3(1)) - links(3).mcm(2)*v3(2))*v3(6) + v3(1)*(-(links(3).mcm(3)*v3(4)) - v3(2)*links(3).inertia(1,1) + v3(1)*links(3).inertia(1,2)) + v3(2)*(-(links(3).mcm(3)*v3(5)) - v3(2)*links(3).inertia(1,2) + v3(1)*links(3).inertia(2,2)) + v3(3)*(links(3).mcm(1)*v3(4) + links(3).mcm(2)*v3(5) - v3(2)*links(3).inertia(1,3) + v3(1)*links(3).inertia(2,3)) - g*links(3).mcm(2)*SG30(1,3) + g*links(3).mcm(1)*SG30(2,3) - uex(3).t(1)*SG30(3,1) - uex(3).t(2)*SG30(3,2) - uex(3).t(3)*SG30(3,3);

pv4(1) = -(links(4).mcm(1)*power(v4(2),2)) - links(4).mcm(1)*power(v4(3),2) + v4(1)*(links(4).mcm(2)*v4(2) + links(4).mcm(3)*v4(3)) - links(4).m*v4(3)*v4(5) + links(4).m*v4(2)*v4(6) - uex(4).f(1)*SG40(1,1) - uex(4).f(2)*SG40(1,2) + g*links(4).m*SG40(1,3) - uex(4).f(3)*SG40(1,3);
pv4(2) = -(links(4).mcm(2)*power(v4(1),2)) - links(4).mcm(2)*power(v4(3),2) + v4(2)*(links(4).mcm(1)*v4(1) + links(4).mcm(3)*v4(3)) + links(4).m*v4(3)*v4(4) - links(4).m*v4(1)*v4(6) - uex(4).f(1)*SG40(2,1) - uex(4).f(2)*SG40(2,2) + g*links(4).m*SG40(2,3) - uex(4).f(3)*SG40(2,3);
pv4(3) = -(links(4).mcm(3)*power(v4(1),2)) - links(4).mcm(3)*power(v4(2),2) + (links(4).mcm(1)*v4(1) + links(4).mcm(2)*v4(2))*v4(3) - links(4).m*v4(2)*v4(4) + links(4).m*v4(1)*v4(5) - uex(4).f(1)*SG40(3,1) - uex(4).f(2)*SG40(3,2) + g*links(4).m*SG40(3,3) - uex(4).f(3)*SG40(3,3);
pv4(4) = (-(links(4).mcm(2)*v4(2)) - links(4).mcm(3)*v4(3))*v4(4) + (links(4).mcm(1)*v4(3) + links(4).m*v4(5))*v4(6) + v4(5)*(links(4).mcm(1)*v4(2) - links(4).m*v4(6)) + v4(1)*(links(4).mcm(2)*v4(5) + links(4).mcm(3)*v4(6) - v4(3)*links(4).inertia(1,2) + v4(2)*links(4).inertia(1,3)) + v4(2)*(-(links(4).mcm(1)*v4(5)) - v4(3)*links(4).inertia(2,2) + v4(2)*links(4).inertia(2,3)) + v4(3)*(-(links(4).mcm(1)*v4(6)) - v4(3)*links(4).inertia(2,3) + v4(2)*links(4).inertia(3,3)) - uex(4).t(1)*SG40(1,1) - uex(4).t(2)*SG40(1,2) - uex(4).t(3)*SG40(1,3) - g*links(4).mcm(3)*SG40(2,3) + g*links(4).mcm(2)*SG40(3,3);
pv4(5) = (-(links(4).mcm(1)*v4(1)) - links(4).mcm(3)*v4(3))*v4(5) + (links(4).mcm(2)*v4(3) - links(4).m*v4(4))*v4(6) + v4(4)*(links(4).mcm(2)*v4(1) + links(4).m*v4(6)) + v4(1)*(-(links(4).mcm(2)*v4(4)) + v4(3)*links(4).inertia(1,1) - v4(1)*links(4).inertia(1,3)) + v4(2)*(links(4).mcm(1)*v4(4) + links(4).mcm(3)*v4(6) + v4(3)*links(4).inertia(1,2) - v4(1)*links(4).inertia(2,3)) + v4(3)*(-(links(4).mcm(2)*v4(6)) + v4(3)*links(4).inertia(1,3) - v4(1)*links(4).inertia(3,3)) + g*links(4).mcm(3)*SG40(1,3) - uex(4).t(1)*SG40(2,1) - uex(4).t(2)*SG40(2,2) - uex(4).t(3)*SG40(2,3) - g*links(4).mcm(1)*SG40(3,3);
pv4(6) = (links(4).mcm(3)*v4(2) + links(4).m*v4(4))*v4(5) + v4(4)*(links(4).mcm(3)*v4(1) - links(4).m*v4(5)) + (-(links(4).mcm(1)*v4(1)) - links(4).mcm(2)*v4(2))*v4(6) + v4(1)*(-(links(4).mcm(3)*v4(4)) - v4(2)*links(4).inertia(1,1) + v4(1)*links(4).inertia(1,2)) + v4(2)*(-(links(4).mcm(3)*v4(5)) - v4(2)*links(4).inertia(1,2) + v4(1)*links(4).inertia(2,2)) + v4(3)*(links(4).mcm(1)*v4(4) + links(4).mcm(2)*v4(5) - v4(2)*links(4).inertia(1,3) + v4(1)*links(4).inertia(2,3)) - g*links(4).mcm(2)*SG40(1,3) + g*links(4).mcm(1)*SG40(2,3) - uex(4).t(1)*SG40(3,1) - uex(4).t(2)*SG40(3,2) - uex(4).t(3)*SG40(3,3);

pv5(1) = -(links(5).mcm(1)*power(v5(2),2)) - links(5).mcm(1)*power(v5(3),2) + v5(1)*(links(5).mcm(2)*v5(2) + links(5).mcm(3)*v5(3)) - links(5).m*v5(3)*v5(5) + links(5).m*v5(2)*v5(6) - uex(5).f(1)*SG50(1,1) - uex(5).f(2)*SG50(1,2) + g*links(5).m*SG50(1,3) - uex(5).f(3)*SG50(1,3);
pv5(2) = -(links(5).mcm(2)*power(v5(1),2)) - links(5).mcm(2)*power(v5(3),2) + v5(2)*(links(5).mcm(1)*v5(1) + links(5).mcm(3)*v5(3)) + links(5).m*v5(3)*v5(4) - links(5).m*v5(1)*v5(6) - uex(5).f(1)*SG50(2,1) - uex(5).f(2)*SG50(2,2) + g*links(5).m*SG50(2,3) - uex(5).f(3)*SG50(2,3);
pv5(3) = -(links(5).mcm(3)*power(v5(1),2)) - links(5).mcm(3)*power(v5(2),2) + (links(5).mcm(1)*v5(1) + links(5).mcm(2)*v5(2))*v5(3) - links(5).m*v5(2)*v5(4) + links(5).m*v5(1)*v5(5) - uex(5).f(1)*SG50(3,1) - uex(5).f(2)*SG50(3,2) + g*links(5).m*SG50(3,3) - uex(5).f(3)*SG50(3,3);
pv5(4) = (-(links(5).mcm(2)*v5(2)) - links(5).mcm(3)*v5(3))*v5(4) + (links(5).mcm(1)*v5(3) + links(5).m*v5(5))*v5(6) + v5(5)*(links(5).mcm(1)*v5(2) - links(5).m*v5(6)) + v5(1)*(links(5).mcm(2)*v5(5) + links(5).mcm(3)*v5(6) - v5(3)*links(5).inertia(1,2) + v5(2)*links(5).inertia(1,3)) + v5(2)*(-(links(5).mcm(1)*v5(5)) - v5(3)*links(5).inertia(2,2) + v5(2)*links(5).inertia(2,3)) + v5(3)*(-(links(5).mcm(1)*v5(6)) - v5(3)*links(5).inertia(2,3) + v5(2)*links(5).inertia(3,3)) - uex(5).t(1)*SG50(1,1) - uex(5).t(2)*SG50(1,2) - uex(5).t(3)*SG50(1,3) - g*links(5).mcm(3)*SG50(2,3) + g*links(5).mcm(2)*SG50(3,3);
pv5(5) = (-(links(5).mcm(1)*v5(1)) - links(5).mcm(3)*v5(3))*v5(5) + (links(5).mcm(2)*v5(3) - links(5).m*v5(4))*v5(6) + v5(4)*(links(5).mcm(2)*v5(1) + links(5).m*v5(6)) + v5(1)*(-(links(5).mcm(2)*v5(4)) + v5(3)*links(5).inertia(1,1) - v5(1)*links(5).inertia(1,3)) + v5(2)*(links(5).mcm(1)*v5(4) + links(5).mcm(3)*v5(6) + v5(3)*links(5).inertia(1,2) - v5(1)*links(5).inertia(2,3)) + v5(3)*(-(links(5).mcm(2)*v5(6)) + v5(3)*links(5).inertia(1,3) - v5(1)*links(5).inertia(3,3)) + g*links(5).mcm(3)*SG50(1,3) - uex(5).t(1)*SG50(2,1) - uex(5).t(2)*SG50(2,2) - uex(5).t(3)*SG50(2,3) - g*links(5).mcm(1)*SG50(3,3);
pv5(6) = (links(5).mcm(3)*v5(2) + links(5).m*v5(4))*v5(5) + v5(4)*(links(5).mcm(3)*v5(1) - links(5).m*v5(5)) + (-(links(5).mcm(1)*v5(1)) - links(5).mcm(2)*v5(2))*v5(6) + v5(1)*(-(links(5).mcm(3)*v5(4)) - v5(2)*links(5).inertia(1,1) + v5(1)*links(5).inertia(1,2)) + v5(2)*(-(links(5).mcm(3)*v5(5)) - v5(2)*links(5).inertia(1,2) + v5(1)*links(5).inertia(2,2)) + v5(3)*(links(5).mcm(1)*v5(4) + links(5).mcm(2)*v5(5) - v5(2)*links(5).inertia(1,3) + v5(1)*links(5).inertia(2,3)) - g*links(5).mcm(2)*SG50(1,3) + g*links(5).mcm(1)*SG50(2,3) - uex(5).t(1)*SG50(3,1) - uex(5).t(2)*SG50(3,2) - uex(5).t(3)*SG50(3,3);

pv6(1) = -(links(6).mcm(1)*power(v6(2),2)) - links(6).mcm(1)*power(v6(3),2) + v6(1)*(links(6).mcm(2)*v6(2) + links(6).mcm(3)*v6(3)) - links(6).m*v6(3)*v6(5) + links(6).m*v6(2)*v6(6) - uex(6).f(1)*SG60(1,1) - uex(6).f(2)*SG60(1,2) + g*links(6).m*SG60(1,3) - uex(6).f(3)*SG60(1,3);
pv6(2) = -(links(6).mcm(2)*power(v6(1),2)) - links(6).mcm(2)*power(v6(3),2) + v6(2)*(links(6).mcm(1)*v6(1) + links(6).mcm(3)*v6(3)) + links(6).m*v6(3)*v6(4) - links(6).m*v6(1)*v6(6) - uex(6).f(1)*SG60(2,1) - uex(6).f(2)*SG60(2,2) + g*links(6).m*SG60(2,3) - uex(6).f(3)*SG60(2,3);
pv6(3) = -(links(6).mcm(3)*power(v6(1),2)) - links(6).mcm(3)*power(v6(2),2) + (links(6).mcm(1)*v6(1) + links(6).mcm(2)*v6(2))*v6(3) - links(6).m*v6(2)*v6(4) + links(6).m*v6(1)*v6(5) - uex(6).f(1)*SG60(3,1) - uex(6).f(2)*SG60(3,2) + g*links(6).m*SG60(3,3) - uex(6).f(3)*SG60(3,3);
pv6(4) = (-(links(6).mcm(2)*v6(2)) - links(6).mcm(3)*v6(3))*v6(4) + (links(6).mcm(1)*v6(3) + links(6).m*v6(5))*v6(6) + v6(5)*(links(6).mcm(1)*v6(2) - links(6).m*v6(6)) + v6(1)*(links(6).mcm(2)*v6(5) + links(6).mcm(3)*v6(6) - v6(3)*links(6).inertia(1,2) + v6(2)*links(6).inertia(1,3)) + v6(2)*(-(links(6).mcm(1)*v6(5)) - v6(3)*links(6).inertia(2,2) + v6(2)*links(6).inertia(2,3)) + v6(3)*(-(links(6).mcm(1)*v6(6)) - v6(3)*links(6).inertia(2,3) + v6(2)*links(6).inertia(3,3)) - uex(6).t(1)*SG60(1,1) - uex(6).t(2)*SG60(1,2) - uex(6).t(3)*SG60(1,3) - g*links(6).mcm(3)*SG60(2,3) + g*links(6).mcm(2)*SG60(3,3);
pv6(5) = (-(links(6).mcm(1)*v6(1)) - links(6).mcm(3)*v6(3))*v6(5) + (links(6).mcm(2)*v6(3) - links(6).m*v6(4))*v6(6) + v6(4)*(links(6).mcm(2)*v6(1) + links(6).m*v6(6)) + v6(1)*(-(links(6).mcm(2)*v6(4)) + v6(3)*links(6).inertia(1,1) - v6(1)*links(6).inertia(1,3)) + v6(2)*(links(6).mcm(1)*v6(4) + links(6).mcm(3)*v6(6) + v6(3)*links(6).inertia(1,2) - v6(1)*links(6).inertia(2,3)) + v6(3)*(-(links(6).mcm(2)*v6(6)) + v6(3)*links(6).inertia(1,3) - v6(1)*links(6).inertia(3,3)) + g*links(6).mcm(3)*SG60(1,3) - uex(6).t(1)*SG60(2,1) - uex(6).t(2)*SG60(2,2) - uex(6).t(3)*SG60(2,3) - g*links(6).mcm(1)*SG60(3,3);
pv6(6) = (links(6).mcm(3)*v6(2) + links(6).m*v6(4))*v6(5) + v6(4)*(links(6).mcm(3)*v6(1) - links(6).m*v6(5)) + (-(links(6).mcm(1)*v6(1)) - links(6).mcm(2)*v6(2))*v6(6) + v6(1)*(-(links(6).mcm(3)*v6(4)) - v6(2)*links(6).inertia(1,1) + v6(1)*links(6).inertia(1,2)) + v6(2)*(-(links(6).mcm(3)*v6(5)) - v6(2)*links(6).inertia(1,2) + v6(1)*links(6).inertia(2,2)) + v6(3)*(links(6).mcm(1)*v6(4) + links(6).mcm(2)*v6(5) - v6(2)*links(6).inertia(1,3) + v6(1)*links(6).inertia(2,3)) - g*links(6).mcm(2)*SG60(1,3) + g*links(6).mcm(1)*SG60(2,3) - uex(6).t(1)*SG60(3,1) - uex(6).t(2)*SG60(3,2) - uex(6).t(3)*SG60(3,3);

pv7(1) = -(links(7).mcm(1)*power(v7(2),2)) - links(7).mcm(1)*power(v7(3),2) + v7(1)*(links(7).mcm(2)*v7(2) + links(7).mcm(3)*v7(3)) - links(7).m*v7(3)*v7(5) + links(7).m*v7(2)*v7(6) - uex(7).f(1)*SG70(1,1) - uex(7).f(2)*SG70(1,2) + g*links(7).m*SG70(1,3) - uex(7).f(3)*SG70(1,3);
pv7(2) = -(links(7).mcm(2)*power(v7(1),2)) - links(7).mcm(2)*power(v7(3),2) + v7(2)*(links(7).mcm(1)*v7(1) + links(7).mcm(3)*v7(3)) + links(7).m*v7(3)*v7(4) - links(7).m*v7(1)*v7(6) - uex(7).f(1)*SG70(2,1) - uex(7).f(2)*SG70(2,2) + g*links(7).m*SG70(2,3) - uex(7).f(3)*SG70(2,3);
pv7(3) = -(links(7).mcm(3)*power(v7(1),2)) - links(7).mcm(3)*power(v7(2),2) + (links(7).mcm(1)*v7(1) + links(7).mcm(2)*v7(2))*v7(3) - links(7).m*v7(2)*v7(4) + links(7).m*v7(1)*v7(5) - uex(7).f(1)*SG70(3,1) - uex(7).f(2)*SG70(3,2) + g*links(7).m*SG70(3,3) - uex(7).f(3)*SG70(3,3);
pv7(4) = (-(links(7).mcm(2)*v7(2)) - links(7).mcm(3)*v7(3))*v7(4) + (links(7).mcm(1)*v7(3) + links(7).m*v7(5))*v7(6) + v7(5)*(links(7).mcm(1)*v7(2) - links(7).m*v7(6)) + v7(1)*(links(7).mcm(2)*v7(5) + links(7).mcm(3)*v7(6) - v7(3)*links(7).inertia(1,2) + v7(2)*links(7).inertia(1,3)) + v7(2)*(-(links(7).mcm(1)*v7(5)) - v7(3)*links(7).inertia(2,2) + v7(2)*links(7).inertia(2,3)) + v7(3)*(-(links(7).mcm(1)*v7(6)) - v7(3)*links(7).inertia(2,3) + v7(2)*links(7).inertia(3,3)) - uex(7).t(1)*SG70(1,1) - uex(7).t(2)*SG70(1,2) - uex(7).t(3)*SG70(1,3) - g*links(7).mcm(3)*SG70(2,3) + g*links(7).mcm(2)*SG70(3,3);
pv7(5) = (-(links(7).mcm(1)*v7(1)) - links(7).mcm(3)*v7(3))*v7(5) + (links(7).mcm(2)*v7(3) - links(7).m*v7(4))*v7(6) + v7(4)*(links(7).mcm(2)*v7(1) + links(7).m*v7(6)) + v7(1)*(-(links(7).mcm(2)*v7(4)) + v7(3)*links(7).inertia(1,1) - v7(1)*links(7).inertia(1,3)) + v7(2)*(links(7).mcm(1)*v7(4) + links(7).mcm(3)*v7(6) + v7(3)*links(7).inertia(1,2) - v7(1)*links(7).inertia(2,3)) + v7(3)*(-(links(7).mcm(2)*v7(6)) + v7(3)*links(7).inertia(1,3) - v7(1)*links(7).inertia(3,3)) + g*links(7).mcm(3)*SG70(1,3) - uex(7).t(1)*SG70(2,1) - uex(7).t(2)*SG70(2,2) - uex(7).t(3)*SG70(2,3) - g*links(7).mcm(1)*SG70(3,3);
pv7(6) = (links(7).mcm(3)*v7(2) + links(7).m*v7(4))*v7(5) + v7(4)*(links(7).mcm(3)*v7(1) - links(7).m*v7(5)) + (-(links(7).mcm(1)*v7(1)) - links(7).mcm(2)*v7(2))*v7(6) + v7(1)*(-(links(7).mcm(3)*v7(4)) - v7(2)*links(7).inertia(1,1) + v7(1)*links(7).inertia(1,2)) + v7(2)*(-(links(7).mcm(3)*v7(5)) - v7(2)*links(7).inertia(1,2) + v7(1)*links(7).inertia(2,2)) + v7(3)*(links(7).mcm(1)*v7(4) + links(7).mcm(2)*v7(5) - v7(2)*links(7).inertia(1,3) + v7(1)*links(7).inertia(2,3)) - g*links(7).mcm(2)*SG70(1,3) + g*links(7).mcm(1)*SG70(2,3) - uex(7).t(1)*SG70(3,1) - uex(7).t(2)*SG70(3,2) - uex(7).t(3)*SG70(3,3);
...
u(7) = u(7) - c7(4)*h7(1) - c7(5)*h7(2) + 0.*h7(3) - c7(1)*h7(4) - c7(2)*h7(5) + 0.*h7(6) - p7(6);
...
u(6) = u(6) - c6(4)*h6(1) - c6(5)*h6(2) + 0.*h6(3) - c6(1)*h6(4) - c6(2)*h6(5) + 0.*h6(6) - p6(6);
...
u(5) = u(5) - c5(4)*h5(1) - c5(5)*h5(2) + 0.*h5(3) - c5(1)*h5(4) - c5(2)*h5(5) + 0.*h5(6) - p5(6);
...
u(4) = u(4) - c4(4)*h4(1) - c4(5)*h4(2) + 0.*h4(3) - c4(1)*h4(4) - c4(2)*h4(5) + 0.*h4(6) - p4(6);
...
u(3) = u(3) - c3(4)*h3(1) - c3(5)*h3(2) + 0.*h3(3) - c3(1)*h3(4) - c3(2)*h3(5) + 0.*h3(6) - p3(6);
...
u(2) = u(2) - c2(4)*h2(1) - c2(5)*h2(2) + 0.*h2(3) - c2(1)*h2(4) - c2(2)*h2(5) + 0.*h2(6) - p2(6);
...
u(1) = u(1) - c1(4)*h1(1) - c1(5)*h1(2) + 0.*h1(3) - c1(1)*h1(4) - c1(2)*h1(5) + 0.*h1(6) - p1(6);
...
qdd(2) = (a1(4) * h2(3) + a1(1) * h2(6) + u(2) - a1(5) * (h2(1) * S21(1,2) ...
         + h2(2) * S21(2,2)) - a1(2) * (h2(4) * S21(1,2) + h2(5) * S21(2,2)) ...
         - a1(3) * (h2(4) * S21(1,3) + h2(5) * S21(2,3)))/d(2);
...
qdd(3) = (-(a2(4) * h3(3)) - a2(1) * h3(6) + u(3) - a2(5) * (h3(1) * S32(1,2) ...
        + h3(2) * S32(2,2)) - a2(6) * (h3(1) * S32(1,3) + h3(2) * S32(2,3)) ...
        - a2(2) * (h3(4) * S32(1,2) - ZHR * h3(1) * S32(1,3) + h3(5) * S32(2,2) ...
        - ZHR * h3(2) * S32(2,3)) - a2(3) * (ZHR * h3(1) * S32(1,2) + ...
        h3(4) * S32(1,3) + ZHR * h3(2) * S32(2,2) + h3(5) * S32(2,3)))/d(3);

a3(1) = c3(1) + a2(2) * S32(1,2) + a2(3) * S32(1,3);
a3(2) = c3(2) + a2(2) * S32(2,2) + a2(3) * S32(2,3);
a3(3) = qdd(3) + a2(1);
a3(4) = c3(4) + ZHR * a2(3) * S32(1,2) + a2(5) * S32(1,2) - ZHR * a2(2) * S32(1,3) ...
        + a2(6) * S32(1,3);
a3(5) = c3(5) + ZHR * a2(3) * S32(2,2) + a2(5) * S32(2,2) - ZHR * a2(2) * S32(2,3) ...
        + a2(6) * S32(2,3);
a3(6) = a2(4);

qdd(4) = (a3(4) * h4(3) + u(4) - a3(5) * (h4(1) * S43(1,2) + h4(2) * S43(2,2)) ...
        - a3(2) * (-(ZEB * h4(3)) + h4(4) * S43(1,2) + h4(5) * S43(2,2)) - a3(6) * ...
        (h4(1) * S43(1,3) + h4(2) * S43(2,3)) - a3(3) * (YEB * h4(3) + h4(4) * ...
        S43(1,3) + h4(5) * S43(2,3)) - a3(1) * (-h4(6) + h4(1) * (-(ZEB * S43(1,2)) ...
        + YEB * S43(1,3)) + h4(2) * (-(ZEB * S43(2,2)) + YEB * S43(2,3))))/d(4);

a4(1) = c4(1) + a3(2) * S43(1,2) + a3(3) * S43(1,3);
a4(2) = c4(2) + a3(2) * S43(2,2) + a3(3) * S43(2,3);
a4(3) = qdd(4) - a3(1);
a4(4) = c4(4) + a3(5) * S43(1,2) + a3(6) * S43(1,3) + a3(1) * (-(ZEB * S43(1,2)) ...
        + YEB * S43(1,3));
a4(5) = c4(5) + a3(5) * S43(2,2) + a3(6) * S43(2,3) + a3(1) * (-(ZEB * S43(2,2)) ...
        + YEB * S43(2,3));
a4(6) = -(ZEB * a3(2)) + YEB * a3(3) - a3(4);

qdd(5) = (-(a4(4) * h5(3)) + u(5) - a4(5) * (h5(1) * S54(1,2) + h5(2) * S54(2,2)) ...
        - a4(6) * (h5(1) * S54(1,3) + h5(2) * S54(2,3)) - a4(1) * (h5(6) + YWR * h5(1) ...
        * S54(1,3) + YWR * h5(2) * S54(2,3)) - a4(2) * (h5(4) * S54(1,2) - ZWR * ...
        h5(1) * S54(1,3) + h5(5) * S54(2,2) - ZWR * h5(2) * S54(2,3)) - a4(3) * ...
        (-(YWR * h5(3)) + ZWR * h5(1) * S54(1,2) + h5(4) * S54(1,3) + ZWR * ...
        h5(2) * S54(2,2) + h5(5) * S54(2,3)))/d(5);

a5(1) = c5(1) + a4(2) * S54(1,2) + a4(3) * S54(1,3);
a5(2) = c5(2) + a4(2) * S54(2,2) + a4(3) * S54(2,3);
a5(3) = qdd(5) + a4(1);
a5(4) = c5(4) + ZWR * a4(3) * S54(1,2) + a4(5) * S54(1,2) + YWR * a4(1) * S54(1,3) ...
        - ZWR * a4(2) * S54(1,3) + a4(6) * S54(1,3);
a5(5) = c5(5) + ZWR * a4(3) * S54(2,2) + a4(5) * S54(2,2) + YWR * a4(1) * S54(2,3) ...
        - ZWR * a4(2) * S54(2,3) + a4(6) * S54(2,3);
a5(6) = -(YWR * a4(3)) + a4(4);

qdd(6) = (a5(4) * h6(3) + u(6) - a5(5) * (h6(1) * S65(1,2) + h6(2) * S65(2,2)) ...
        - a5(1) * (-h6(6) - ZWFE * h6(1) * S65(1,2) - ZWFE * h6(2) * S65(2,2)) ...
        - a5(2) * (-(ZWFE * h6(3)) + h6(4) * S65(1,2) + h6(5) * S65(2,2)) - ...
         a5(6) * (h6(1) * S65(1,3) + h6(2) * S65(2,3)) - a5(3) * (h6(4) * S65(1,3) ...
         + h6(5) * S65(2,3)))/d(6);
...
qdd(7) = (-(a6(4) * h7(3)) - a6(1) * h7(6) + u(7) - a6(5) * (h7(1) * S76(1,2) + ...
         h7(2) * S76(2,2)) - a6(2) * (h7(4) * S76(1,2) + h7(5) * S76(2,2)) - a6(6) * ...
         (h7(1) * S76(1,3) + h7(2) * S76(2,3)) - a6(3) * (h7(4) * S76(1,3) + ...
         h7(5) * S76(2,3)))/d(7);
...
if flag
    ...
    switch METHOD
        ...
        % Take fourteen differences with h small
        h = 1e-3;
        ...
        %dfdu = Mbig \ Bx;
        uhPlus = repmat(u0,1,NDOF) + h * eye(NDOF);
        uhMinus = repmat(u0,1,NDOF) - h * eye(NDOF);
        ...
        h = 1e-3;
        Q2hPlus = repmat(Q,1,2*NDOF) + 2*h * eye(2*NDOF);
        QhPlus = repmat(Q,1,2*NDOF) + h * eye(2*NDOF);
        QhMinus = repmat(Q,1,2*NDOF) - h * eye(2*NDOF);
        Q2hMinus = repmat(Q,1,2*NDOF) - 2*h * eye(2*NDOF);
        Qd2hPlus = zeros(2*NDOF);
        QdhPlus = zeros(2*NDOF);
        QdhMinus = zeros(2*NDOF);
        ...
        dfdx = [zeros(NDOF), eye(NDOF); der(NDOF+1:2*NDOF,:)];
        %
        u2hPlus = repmat(u0,1,NDOF) + 2*h * eye(NDOF);
        uhPlus = repmat(u0,1,NDOF) + h * eye(NDOF);
        uhMinus = repmat(u0,1,NDOF) - h * eye(NDOF);
        u2hMinus = repmat(u0,1,NDOF) - 2*h * eye(NDOF);
        QdhPlus = zeros(2*NDOF,NDOF);
        Qd2hPlus = zeros(2*NDOF,NDOF);
        QdhMinus = zeros(2*NDOF,NDOF);
