...
h3 = line(link3_x, link2_y, 'color', [.4 .4 .4],'LineWidth',4);
title('Two-link planar arm');
hold on;
h4 = scatter(shift(1),shift(2),100,'b','LineWidth',4);
h5 = scatter(x1(1,1),x1(2,1),100,'b','LineWidth',4);
h6 = scatter(x2(1,1),x2(2,1),10,'b','LineWidth',4);
h7 = scatter(x3(1,1),x3(2,1),10,'b','LineWidth',4);
