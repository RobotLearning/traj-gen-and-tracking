...
movement primitives allow for efficient representation of such tasks from demonstrations, the optimization of the required motor commands for systems with inaccurate dynamic models remains an open problem.
