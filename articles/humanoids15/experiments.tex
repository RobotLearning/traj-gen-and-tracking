...
\includegraphics[width=0.45\linewidth]{putting0.pdf}
\label{fig:subfig1}}
\subfloat[Final trajectory]{%
\includegraphics[width=0.55\linewidth]{puttingLastTraj.pdf}
\label{fig:subfig2}}
...
\begin{figure}
\centering
\includegraphics[scale=0.25]{ilc_putting_comp.pdf}
...
\begin{figure}
\center
\includegraphics[scale=0.40]{tt0.pdf}
