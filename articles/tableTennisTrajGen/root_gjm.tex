...
% some shortcuts to make comments.
...
\newcommand{\wrong}[1]{\color{red}{#1}\color{black}}
\newcommand{\comment}[1]{\color{green}{#1}\color{black}} % comments so you understand what I mean, but should not be part of the text
